 ...
 * size (so the top part lines up pixel-perfectly with the sharp window
 * background behind it), then a translucent white scrim on top. Works on all
 * API levels, no runtime RenderEffect needed.
 */
class FrostDrawable(
